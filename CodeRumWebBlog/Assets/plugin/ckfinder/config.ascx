...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "MrKatsu";
        LicenseKey = "RSH115UW2CGDNTPMBJR7UF86GQXE9V4K";


        var userSession = (CodeRumWebBlog.UserLogin)Session["USER_SESSION"];
        ...
        BaseDir = $@"d:\DZHosts\LocalUser\mrkatsu2212\www.mrkatsu.somee.com\Resourse\data\{userId}\";

        //Common.FTPServices.ConnectToFtpAndCreateDirectory(BaseDir);
